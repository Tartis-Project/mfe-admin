...
describe('HomeComponent', () => {
  ...
  const mockKeycloakService = {
    ...
    loadUserProfile: jasmine
      ...
      .and.returnValue(Promise.resolve({ name: 'Test User' })),
  ...
  beforeEach(async () => {
    ...
    registryServiceMock = jasmine.createSpyObj('RegistryService', [
      'getRegistries',
    ]);
    ...
    vehicleServiceMock.getVehicles.and.returnValue(
      of([
        {
          id: '1',
          licensePlate: 'ABC123',
    ...
    parkingServiceMock.getFloors.and.returnValue(
      of([
        {
          id: '8617',
          floorNumber: 1,
    ...
    parkingSpotServiceMock.getParkingSpots.and.returnValue(
      of([
        {
          id: '79b7',
          idFloor: '8617',
    ...
    registryServiceMock.getRegistries.and.returnValue(
      of([
        {
  ...
  it('should unsubscribe pollingSubscription on destroy', () => {
    component['pollingSubscription'] = jasmine.createSpyObj('Subscription', [
      'unsubscribe',
    ]);
