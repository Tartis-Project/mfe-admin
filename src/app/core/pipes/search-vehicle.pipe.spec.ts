...
describe('SearchVehiclePipe', () => {
  ...
  it('should return the original array when no searchTerm is provided', () => {
    const vehicles: Vehicle[] = [
      { id: '1', licensePlate: 'ABC123', model: 'Toyota', type: 'Sedan', color: 'Red', isActive: true },
      { id: '2', licensePlate: 'XYZ456', model: 'Honda', type: 'SUV', color: 'Blue', isActive: true },
    ];
  ...
  it('should filter vehicles based on multiple search terms (license plate, type, model, and color)', () => {
    const vehicles: Vehicle[] = [
      { id: '1', licensePlate: 'ABC123', model: 'Toyota', type: 'Sedan', color: 'Red', isActive: true },
      { id: '2', licensePlate: 'XYZ456', model: 'Honda', type: 'SUV', color: 'Blue', isActive: true },
      { id: '3', licensePlate: 'DEF789', model: 'Ford', type: 'Truck', color: 'Green', isActive: true },
    ];
