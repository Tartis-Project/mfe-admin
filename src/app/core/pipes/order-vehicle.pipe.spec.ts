...
describe('OrderVehiclePipe', () => {
  ...
  it('should return the vehicles in the correct order when "new" is passed as order', () => {
    ...
    const registries: Registry[] = [
      {
        idVehicle: '1',
        entryTime: new Date('2025-03-06T12:00:00'),
        exitTime: new Date('2025-03-06T12:00:00'),
        id: '',
        idParkingSpot: '',
        idRate: '',
      },
      {
        idVehicle: '2',
        entryTime: new Date('2025-03-07T12:00:00'),
        exitTime: new Date('2025-03-07T12:00:00'),
        id: '',
        idParkingSpot: '',
        idRate: '',
      },
